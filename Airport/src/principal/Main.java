...
public class Main {
	...
	public static void main(String[] args) {
		...
		ArrayList<Aviao> aHangar = new ArrayList();
		ArrayList<Aviao> aPistaSul = new ArrayList();
		ArrayList<Aviao> aPistaNorte = new ArrayList();
		ArrayList<Aviao> aAirway10000 = new ArrayList();
		ArrayList<Aviao> aAirway15000 = new ArrayList();
		ArrayList<Aviao> aAirway20000 = new ArrayList();
